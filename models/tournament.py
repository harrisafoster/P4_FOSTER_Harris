...
class Tournament:
    ...
    def access_tournament_object(self, name_of_tournament):
        tournament_instance = self.db_tournaments.search(self.query['name_of_tournament'] == name_of_tournament)
    ...
    def delete_match(self, round_number, match_number):
        tournament_dict = self.db_tournaments.search(where('name_of_tournament') == self.name_of_tournament)
